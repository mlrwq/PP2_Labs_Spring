...
bg1 = pygame.image.load(r"C:\Users\Admin\OneDrive\Рабочий стол\githowto\repositories\Labs\Lab_7\player\IMG_0176 (1).JPEG")
bg2 = pygame.image.load(r"C:\Users\Admin\OneDrive\Рабочий стол\githowto\repositories\Labs\Lab_7\player\IMG_0177 (2).JPEG")

bg1 = pygame.transform.scale(bg1, (500,800))
bg2 = pygame.transform.scale(bg2, (500,800))

playlist = r"C:\Users\Admin\OneDrive\Рабочий стол\githowto\repositories\Labs\Lab_7\player\songs"
music = os.listdir(playlist)

cover_folder = r"C:\Users\Admin\OneDrive\Рабочий стол\githowto\repositories\Labs\Lab_7\player\covers"
